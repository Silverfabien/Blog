 ...
 */
final class Version20260102164836 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD picture_file VARCHAR(255) DEFAULT NULL');
    }
}
